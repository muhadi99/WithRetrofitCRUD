...
public class ReadFragment extends Fragment {
        ...
        mApiService.readData(
                ...
                .enqueue(new Callback<ReadDataResponse>() {
                    ...
                    public void onResponse(Call<ReadDataResponse> call, Response<ReadDataResponse> response) {
                        //mematikan progresbar atau skeleton dgn GONE atau hide
    ...
    public void onResume() {
        super.onResume();
        //menampilkan progresbar atau skeleton
        pb_load.setVisibility(View.GONE); //untuk menghindari duplikat maka di GONE. diaktifkan lagi dgn VISIBLE
        shimmer_recycler_view.showShimmerAdapter(); //ini yg digunakan
